...
const teams = [
  { id: 1,  group: 3, slot: 'G', name: 'HUMILDAD', cofradia: 'Hdad. y Cofradía de Nazarenos del S Cristo de la Humildad en su Presentación Ante Pilato y Ntra. Madre Y Sra. de Consolación y Esperanza', primary: '#800020', secondary: '#ffffff', kit: 'solid', shieldImg: 'kits/humildad-escudo-01.png', kitImgA: 'kits/HUMILDAD-A.png', kitImgB: 'kits/HUMILDAD-B.png', pending: false },
  { id: 2,  group: 3, slot: 'I', name: 'PADRE JESÚS', cofradia: 'Real Cofradía de Ntro. Padre Jesús Nazareno y María Santísima de los Dolores', primary: '#6a1b9a', secondary: '#ffffff', kit: 'solid', shieldImg: 'kits/pjes.png', kitImgA: 'kits/PADRE-JESUS-A.png', kitImgB: 'kits/PADRE-JESUS-B.png', pending: false },
  { id: 3,  group: 2, slot: 'E', name: 'RESUCITADO', cofradia: 'Cofradía del Santísimo Cristo Resucitado', primary: '#c62828', secondary: '#ffffff', kit: 'solid', shieldImg: 'kits/escudo-resucitado.png', kitImgA: 'kits/RESUCITADO-A.png', kitImgB: 'kits/RESUCITADO-B.png', pending: false },
  { id: 4,  group: 1, slot: 'B', name: 'GRUPO JOVEN VERA CRUX', cofradia: 'Cofradía de la Santa Vera Crux y Santiago Apóstol', primary: '#B5DCCA', secondary: '#000000', kit: 'solid', shieldImg: 'kits/escudo-grupo-joven.png', kitImgA: 'kits/GRUPO-JOVEN-A.png', kitImgB: 'kits/GRUPO-JOVEN-B.png', pending: false },
  { id: 5,  group: 1, slot: 'C', name: 'JESÚS CAÍDO', cofradia: 'Agrupación Musical Jesús Caído', primary: '#0d1b4b', secondary: '#ffffff', kit: 'solid', shieldImg: 'kits/escudo-jesus-caido.png', kitImgA: 'kits/JESUS-CAIDO-A.png', kitImgB: 'kits/JESUS-CAIDO-B.png', pending: false },
  { id: 6,  group: 2, slot: 'D', name: 'SANTO ENTIERRO', cofradia: 'Cofradía Sacramental del Santo Sepulcro y Ntra. Sra. de la Soledad', primary: '#1a1a1a', secondary: '#ffffff', kit: 'solid', shieldImg: 'kits/escudo-santo-entierro.png', kitImgA: 'kits/SANTO-ENTIERRO-A.png', kitImgB: 'kits/SANTO-ENTIERRO-B.png', pending: false },
  { id: 7,  group: 1, slot: 'A', name: 'IMPERIO ROMANO', cofradia: 'Imperio Romano de Montoro', primary: '#0000FD', secondary: '#ffffff', kit: 'solid', shieldImg: 'kits/escudo-romanos.png', kitImgA: 'kits/ROMANOS-A.png', kitImgB: 'kits/ROMANOS-B.png', pending: false },
  { id: 8,  group: 4, slot: 'J', name: 'VERA CRUX', cofradia: 'Cofradía de la Santa Vera Crux y Santiago Apóstol', primary: '#174C27', secondary: '#ffffff', kit: 'solid', shieldImg: 'kits/escudo-vera-crux.png', kitImgA: 'kits/VERA-CRUX-A.png', kitImgB: 'kits/VERA-CRUX-B.png', pending: false },
  { id: 9,  group: 2, slot: 'F', name: 'COSTALERAS AMOR Y PAZ', cofradia: 'Cofradía de la Entrada Triunfal de Jesús en Jerusalén y María Santísima del Amor y la Paz Madre protectora de la Infancia con los abuelos San Joaquín y Santa Ana y muy antigua y Piadosa Hermandad de Ntro. Padre Jesús del Calvario', primary: '#FB3D8B', secondary: '#ffffff', kit: 'solid', shieldImg: 'kits/escudo-borriquita.png', kitImgA: 'kits/BORRIQUITA-A.png', kitImgB: 'kits/BORRIQUITA-B.png', pending: false },
  { id: 10, group: 3, slot: 'H', name: 'FLAGELACIÓN', cofradia: 'Hermandad del Santísimo Cristo de la Flagelación y Ntra. Sra. del Rosario en sus Misterios Dolorosos', primary: '#6F1749', secondary: '#ffffff', kit: 'solid', shieldImg: 'kits/escudo-flagelacion.png', kitImgA: 'kits/FLAGELACION-A.png', kitImgB: 'kits/FLAGELACION-B.png', pending: false },
  { id: 11, group: 4, slot: 'K', name: 'VIRGEN DE LA CABEZA', cofradia: 'Cofradía de Nuestra Señora de la Cabeza de Montoro', primary: '#8AC7E4', secondary: '#ffffff', kit: 'solid', shieldImg: 'kits/escudo-cabeza.png', kitImgA: 'kits/CABEZA-A.png', kitImgB: 'kits/CABEZA-B.png', pending: false },
  { id: 12, group: 4, slot: 'L', name: 'LOS ESTUDIANTES', cofradia: 'Cofradía del Santísimo Cristo de la Misericordia y Ntra. Sra. de las Angustias', primary: '#D2CC98', secondary: '#000000', kit: 'solid', shieldImg: 'kits/escudo-misericordia.png', kitImgA: 'kits/ESTUDIANTES-A.png', kitImgB: 'kits/ESTUDIANTES-B.png', pending: false },
];
