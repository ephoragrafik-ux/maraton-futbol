...
const teams = [
  ...
  { id: 5,  group: null, slot: null, name: 'JESÚS CAÍDO', cofradia: 'Agrupación Musical Jesús Caído', primary: '#0d1b4b', secondary: '#ffffff', kit: 'solid', shieldImg: 'kits/escudo-jesus-caido.png', kitImgA: 'kits/JESUS-CAIDO-A.png', kitImgB: 'kits/JESUS-CAIDO-B.png', pending: false },
  { id: 6,  group: null, slot: null, name: 'SANTO ENTIERRO', cofradia: 'Cofradía Sacramental del Santo Sepulcro y Ntra. Sra. de la Soledad', primary: '#1a1a1a', secondary: '#ffffff', kit: 'solid', shieldImg: 'kits/escudo-santo-entierro.png', kitImgA: 'kits/SANTO-ENTIERRO-A.png', kitImgB: 'kits/SANTO-ENTIERRO-B.png', pending: false },
  { id: 7,  group: null, slot: null, name: 'IMPERIO ROMANO', cofradia: 'Imperio Romano de Montoro', primary: '#0000FD', secondary: '#ffffff', kit: 'solid', shieldImg: 'kits/escudo-romanos.png', kitImgA: 'kits/ROMANOS-A.png', kitImgB: 'kits/ROMANOS-B.png', pending: false },
  { id: 8,  group: null, slot: null, name: 'VERA CRUX', cofradia: 'Cofradía de la Santa Vera Crux y Santiago Apóstol', primary: '#174C27', secondary: '#ffffff', kit: 'solid', shieldImg: 'kits/escudo-vera-crux.png', kitImgA: 'kits/VERA-CRUX-A.png', kitImgB: 'kits/VERA-CRUX-B.png', pending: false },
