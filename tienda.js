...
const products = [
  ...
  { id:10, name:'FLAGELACIÓN',          cofradia:'Hermandad del Santísimo Cristo de la Flagelación y Ntra. Sra. del Rosario en sus Misterios Dolorosos',  primary:'#6F1749', secondary:'#ffffff', kit:'solid', kitImgA:'kits/FLAGELACION-A.png', kitImgB:'kits/FLAGELACION-B.png' },
  { id:11, name:'VIRGEN DE LA CABEZA', cofradia:'Cofradía de Nuestra Señora de la Cabeza de Montoro',                                                          primary:'#8AC7E4', secondary:'#ffffff', kit:'solid', kitImgA:'kits/CABEZA-A.png',       kitImgB:'kits/CABEZA-B.png'       },
